      ...
      <View className="w-full flex-col space-y-1 mt-5">
        ...
        >
          <View className="flex flex-row space-x-2">
            <Icon name="user" size={20} color={WARNA_TERNARY} className="text-black mr-2" />
            <Text className="text-black flex-1">Edit Profil</Text>
          </View>
          <Icon name="angle-right" size={20} color={WARNA_TERNARY} className="text-black" />
        </TouchableOpacity>
        ...
        >
          <View className="flex flex-row space-x-2">
            <Icon name="lock" size={20} color={WARNA_TERNARY} className="text-black mr-2" />
        ...
        >
          <View className="flex flex-row space-x-2">
            <Icon name="sign-out" size={20} color={WARNA_TERNARY} className="text-black mr-2" />
